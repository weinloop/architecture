...
>
> **1.** **大模型选型与云原生部署**：推理容器化、异构 GPU 节点池、Prometheus 指标驱动 HPA 弹性扩缩。
> **2.** **大模型与业务集成**：统一推理 API 网关 + **RAG/向量库** + Prompt 约束，抑幻觉、贴合民航领域知识。
> **3.** **运维与治理**：监控与多租户配额限流、敏感信息脱敏与审计、Token 级成本分摊。
