...
const paperSidebar = [
  ...
  { text: '整体知识（12 章）', link: '/整体知识/' },
  { text: '论文目录', link: '/论文/' },
  { text: '数据资产 · 背诵记忆锚点', link: '/数据资产智能/论文/背诵记忆锚点' },
  { text: '数据资产 · 核心论文重点版（十二篇）', link: '/数据资产智能/论文/重点版/1.大模型及AI_Coding技术应用' },
  { text: '大白话论文汇总', link: '/数据资产智能/论文/大白话汇总' },
  { text: '数据资产 · 技术点与三段 SCQA', link: '/数据资产智能/论文/论文技术点和三段' },
  { text: '数据资产 · 十二篇背诵汇总', link: '/数据资产智能/论文/背诵汇总' },
  { text: '数据资产 · 十二篇思维导图', link: '/数据资产智能/论文/思维导图/' },
  {
    text: '架构论文横向对比',
    collapsed: false,
    items: [
      { text: '背景对比', link: '/数据资产智能/论文/项目背景集合' },
      { text: '过渡对比', link: '/数据资产智能/论文/过度集合' },
      { text: '论点一对比', link: '/数据资产智能/论文/论点一集合' },
      { text: '论点二对比', link: '/数据资产智能/论文/论点二集合' },
      { text: '论点三对比', link: '/数据资产智能/论文/论点三集合' },
    ]
  },
  {
    text: '云原生架构专题',
...
const dataAssetSidebar = [
  ...
  { text: '背诵记忆锚点', link: '/数据资产智能/论文/背诵记忆锚点' },
  { text: '正文归纳汇总', link: '/数据资产智能/论文/正文归纳汇总' },
  {
    text: '核心论文·重点版（十二篇）',
    collapsed: false,
    items: [
      { text: '1. 大模型及 AI Coding', link: '/数据资产智能/论文/重点版/1.大模型及AI_Coding技术应用' },
      { text: '2. 可靠性设计', link: '/数据资产智能/论文/重点版/2.云原生-论可靠性设计' },
      { text: '3. 服务网格', link: '/数据资产智能/论文/重点版/3.云原生-服务网格' },
      { text: '4. 大数据 Kappa', link: '/数据资产智能/论文/重点版/4.大数据Kappa架构设计应用' },
      { text: '5. 缓存技术应用', link: '/数据资产智能/论文/重点版/5.云原生-缓存技术应用' },
      { text: '6. 智能运维', link: '/数据资产智能/论文/重点版/6.智能运维AIOps应用' },
      { text: '7. 自动化测试', link: '/数据资产智能/论文/重点版/7.自动化测试应用' },
      { text: '8. 可靠性测试', link: '/数据资产智能/论文/重点版/8.可靠性测试' },
      { text: '9. 存储计算分离', link: '/数据资产智能/论文/重点版/9.云原生-存储计算分离应用实践' },
      { text: '10. 可观测性设计', link: '/数据资产智能/论文/重点版/10.云原生-可观测性设计实践' },
      { text: '11. 容器化技术', link: '/数据资产智能/论文/重点版/11.云原生-容器化技术应用' },
      { text: '12. 消息中间件', link: '/数据资产智能/论文/重点版/12.云原生-消息中间件技术应用' },
    ],
  },
  ...
  { text: '十二篇背诵汇总', link: '/数据资产智能/论文/背诵汇总' },
  {
    ...
    collapsed: false,
    items: [
      { text: '总览', link: '/数据资产智能/论文/思维导图/' },
      { text: '1. 大模型及 AI Coding', link: '/数据资产智能/论文/思维导图/01-大模型及AI-Coding' },
      { text: '2. 云原生可靠性', link: '/数据资产智能/论文/思维导图/02-云原生可靠性' },
      { text: '3. 服务网格', link: '/数据资产智能/论文/思维导图/03-服务网格' },
      { text: '4. 大数据 Kappa', link: '/数据资产智能/论文/思维导图/04-Kappa架构' },
      { text: '5. 缓存技术', link: '/数据资产智能/论文/思维导图/05-缓存技术' },
      { text: '6. 智能运维 AIOps', link: '/数据资产智能/论文/思维导图/06-智能运维-AIOps' },
      { text: '7. 自动化测试', link: '/数据资产智能/论文/思维导图/07-自动化测试' },
      { text: '8. 可靠性测试', link: '/数据资产智能/论文/思维导图/08-可靠性测试' },
      { text: '9. 存储计算分离', link: '/数据资产智能/论文/思维导图/09-存储计算分离' },
      { text: '10. 可观测性', link: '/数据资产智能/论文/思维导图/10-可观测性' },
      { text: '11. 容器化', link: '/数据资产智能/论文/思维导图/11-容器化' },
      { text: '12. 消息中间件', link: '/数据资产智能/论文/思维导图/12-消息中间件' },
    ],
  },
  {
    text: '101 备考汇总',
  ...
  },
  {
    ...
    collapsed: false,
    items: [
      { text: '1. 大模型及 AI Coding', link: '/数据资产智能/论文/专题拆解-1-大模型AI' },
      { text: '2. 云原生可靠性设计', link: '/数据资产智能/论文/专题拆解-2-可靠性设计' },
      { text: '3. 云原生服务网格', link: '/数据资产智能/论文/专题拆解-3-服务网格' },
      { text: '4. 大数据 Kappa 架构', link: '/数据资产智能/论文/专题拆解-4-Kappa架构' },
      { text: '5. 云原生缓存技术', link: '/数据资产智能/论文/专题拆解-5-缓存技术' },
      { text: '6. 智能运维 AIOps', link: '/数据资产智能/论文/专题拆解-6-智能运维AIOps' },
      { text: '7. 自动化测试应用', link: '/数据资产智能/论文/专题拆解-7-自动化测试' },
      { text: '8. 可靠性测试技术', link: '/数据资产智能/论文/专题拆解-8-可靠性测试' },
      { text: '9. 存储计算分离实践', link: '/数据资产智能/论文/专题拆解-9-存储计算分离' },
      { text: '10. 可观测性设计实践', link: '/数据资产智能/论文/专题拆解-10-可观测性' },
      { text: '11. 容器化技术应用', link: '/数据资产智能/论文/专题拆解-11-容器化技术' },
      { text: '12. 消息中间件应用', link: '/数据资产智能/论文/专题拆解-12-消息中间件' },
    ]
  },
  {
    text: '横向对比集合',
    collapsed: false,
    items: [
      { text: '项目背景对比', link: '/数据资产智能/论文/项目背景集合' },
      { text: '过渡段落对比', link: '/数据资产智能/论文/过度集合' },
      { text: '论点一对比', link: '/数据资产智能/论文/论点一集合' },
      { text: '论点二对比', link: '/数据资产智能/论文/论点二集合' },
      { text: '论点三对比', link: '/数据资产智能/论文/论点三集合' },
    ]
    ...
    nav: [
      ...
      { text: '复习计划', link: '/plan/30天冲刺内容' },
      {
        ...
        items: [
          ...
          { text: '资产·背诵记忆锚点', link: '/数据资产智能/论文/背诵记忆锚点' },
          { text: '资产·正文归纳', link: '/数据资产智能/论文/正文归纳汇总' },
          { text: '资产·重点版论文', link: '/数据资产智能/论文/重点版/1.大模型及AI_Coding技术应用' },
          { text: '资产·背景对比', link: '/数据资产智能/论文/项目背景集合' },
          { text: '资产·过度对比', link: '/数据资产智能/论文/过度集合' },
          { text: '资产·论点一', link: '/数据资产智能/论文/论点一集合' },
          ...
          { text: '资产·大白话汇总', link: '/数据资产智能/论文/大白话汇总' },
          { text: '资产·十二篇背诵汇总', link: '/数据资产智能/论文/背诵汇总' },
          { text: '资产·十二篇思维导图', link: '/数据资产智能/论文/思维导图/' },
        ],
      },
    ],
    sidebar: {
